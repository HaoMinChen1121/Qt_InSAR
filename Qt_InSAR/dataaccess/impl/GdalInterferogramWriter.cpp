    ...
    int width, int height, bool isComplex)
{
    ...
    // Band 1: CFloat32 (complex interferogram)
    // Band 2: Float32 (phase) — added via GDALAddBand
    // Band 3: Float32 (coherence) — added via GDALAddBand
    GDALDatasetH hDS = GDALCreate(driver, filePath.toUtf8().constData(),
        width, height, 1, isComplex ? GDT_CFloat32 : GDT_Float32, nullptr);
